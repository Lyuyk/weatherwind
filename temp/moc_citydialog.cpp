/****************************************************************************
** Meta object code from reading C++ file 'citydialog.h'
**
...
#error "The header file 'citydialog.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_cityDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cityDialog_t qt_meta_stringdata_cityDialog = {
    {
QT_MOC_LITERAL(0, 0, 10) // "cityDialog"
...
QT_INIT_METAOBJECT const QMetaObject cityDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_cityDialog.data,
    qt_meta_data_cityDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cityDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cityDialog.stringdata0))
